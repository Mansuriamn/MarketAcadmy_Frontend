...
const InstallPWA = () => {
  ...
  return (
    <>
      ...
      {showSuccess && (
        <div className="fixed top-6 left-1/2 -translate-x-1/2 z-[100] w-[90%] max-w-md animate-drop-down">
          <div className="bg-white/90 dark:bg-slate-900/90 border border-emerald-500/30 shadow-2xl rounded-2xl p-4 flex items-center justify-between gap-4 backdrop-blur-xl">
